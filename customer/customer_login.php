...
customerRestrictLoginRegisterAccess();
                ...
                <div class="card border border-light-subtle rounded-4">
                    <div class="card-body p-3 p-md-4 p-xl-5">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-5">
                                    <h4 class="text-center">Customer Login Here</h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-center">
                                    <a href="./customer_register.php" class="link-secondary text-decoration-none">Click here to Register</a>
                                </div>
                            </div>
                        </div>
                    </div>
